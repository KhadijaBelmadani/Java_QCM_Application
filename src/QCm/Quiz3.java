...
public class Quiz3 implements ActionListener {
	...
	JLabel Title = new JLabel("Question3");
	JLabel question1 = new JLabel( "3) Given a method with one of the following return types,which date type prevents"+" return statement from being used within the method? ");
	JCheckBox answer1 = new JCheckBox("a. byte");
	JCheckBox answer2 = new JCheckBox("b. String");
	JCheckBox answer3 = new JCheckBox("c. void");
