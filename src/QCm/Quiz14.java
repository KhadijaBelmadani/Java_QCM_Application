...
public class Quiz14 implements ActionListener {
	static int count;
	JFrame frame = new JFrame();
	JLabel Title = new JLabel("Question14");
	JLabel question1 = new JLabel( "14) How many of the loop types (while,do while,traditional for,and enhanced for) "+"allow you to write code that creates an infinite loop?"  );
	JCheckBox answer1 = new JCheckBox("a. One");
	JCheckBox answer2 = new JCheckBox("b. Two");
	JCheckBox answer3 = new JCheckBox("c.Three");
	JCheckBox answer4 = new JCheckBox("d. Four");
