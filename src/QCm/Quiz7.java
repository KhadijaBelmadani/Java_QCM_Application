...
public class Quiz7 implements ActionListener {
	static int count;
	JFrame frame = new JFrame();
	JLabel Title = new JLabel("Question7");
	JLabel question1 = new JLabel( "7) Which of the following are primitives? "+"int lowercase=new int[0];"+"Integer[] uppercase =new Integer[0];" );
	JCheckBox answer1 = new JCheckBox("a. Only lowercase");
	JCheckBox answer2 = new JCheckBox("b. Only uppercase");
	JCheckBox answer3 = new JCheckBox("c. Both lowercase and suppercase");
	JCheckBox answer4 = new JCheckBox("d. Neither lowercase and suppercase");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==submitButton) {
			...
			if(answer1.isSelected()) {
				answer="a.  Only lowercase";
			}
			if(answer2.isSelected()) {
				answer="b. Only uppercase";
			}
			if(answer3.isSelected()) {
				answer="c.Both lowercase and suppercase";
			}
			if(answer4.isSelected()) {
				answer="d. Neither lowercase and suppercase";
			}
			if(answer=="d.  Neither lowercase and suppercase")
			{
				JOptionPane.showMessageDialog(null, "The result is");
				JOptionPane.showMessageDialog(null, "Correct Answer");
				count+=1;
				Quiz8 q8=new Quiz8(count);
