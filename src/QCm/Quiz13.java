...
public class Quiz13 implements ActionListener {
	static int count;
	JFrame frame = new JFrame();
	JLabel Title = new JLabel("Question13");
	JLabel question1 = new JLabel( "13) What is keyword is used to end the current loop itteration and proceed execution "+"with the next iteration of taht loop "  );
	JCheckBox answer1 = new JCheckBox("a. break");
	JCheckBox answer2 = new JCheckBox("b. continue");
	JCheckBox answer3 = new JCheckBox("c.end");
	JCheckBox answer4 = new JCheckBox("d. skip");
