...
public class Quiz16 implements ActionListener {
	static int count;
	JFrame frame = new JFrame();
	JLabel Title = new JLabel("Question16");
	JLabel question1 = new JLabel( "16) Fill in the blank: A------------variable is always available to all instances of the class." );
	JCheckBox answer1 = new JCheckBox("a. public");
	JCheckBox answer2 = new JCheckBox("b. local");
	JCheckBox answer3 = new JCheckBox("c.static");
	JCheckBox answer4 = new JCheckBox("d. instance");
