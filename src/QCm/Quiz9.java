...
public class Quiz9 implements ActionListener {
	static int count;
	JFrame frame = new JFrame();
	JLabel Title = new JLabel("Question9");
	JLabel question1 = new JLabel( "9) How do you determine the number of elements in an array?" );
	JCheckBox answer1 = new JCheckBox("a. buses.length");
	JCheckBox answer2 = new JCheckBox("b. buses.length()");
	JCheckBox answer3 = new JCheckBox("c. buses.size");
	JCheckBox answer4 = new JCheckBox("d. buses.size()");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==submitButton) {
			...
			if(answer1.isSelected()) {
				answer="a.  buses.length";
			}
			if(answer2.isSelected()) {
				answer="b. buses.length()";
			}
