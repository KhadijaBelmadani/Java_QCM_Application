...
public class Quiz8 implements ActionListener {
	static int count;
	JFrame frame = new JFrame();
	JLabel Title = new JLabel("Question8");
	JLabel question1 = new JLabel( "8) How many of the following are legal declarations?"+"[]double lion;"+"double[] tiger;"+"double bear[];" );
	JCheckBox answer1 = new JCheckBox("a. None");
	JCheckBox answer2 = new JCheckBox("b. One");
	JCheckBox answer3 = new JCheckBox("c. Two");
	JCheckBox answer4 = new JCheckBox("d. Three");
