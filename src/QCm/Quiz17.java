...
public class Quiz17 implements ActionListener {
	static int count;
	JFrame frame = new JFrame();
	JLabel Title = new JLabel("Question17");
	JLabel question1 = new JLabel( "17) which of the following data types can be modified after they are passed to  a method as an argument?" );
	JCheckBox answer1 = new JCheckBox("a. int[]");
	JCheckBox answer2 = new JCheckBox("b. String");
	JCheckBox answer3 = new JCheckBox("c.long");
	JCheckBox answer4 = new JCheckBox("d. boolean");
