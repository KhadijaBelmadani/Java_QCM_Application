...
public class Quiz2 implements ActionListener {
	...
	JLabel Title = new JLabel("Question2");
	JLabel question1 = new JLabel( "2) Which variables have a scope limited to a method? ");
	JCheckBox answer1 = new JCheckBox("a. Interface variables");
	JCheckBox answer2 = new JCheckBox("b. Class variables");
	JCheckBox answer3 = new JCheckBox("c. Instance varibles");
	JCheckBox answer4 = new JCheckBox("d. Local variables");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==submitButton) {
			...
			if(answer1.isSelected()) {
				answer="a. Interface variables";
			}
			if(answer2.isSelected()) {
				answer="b.  Class variables";
			}
			if(answer3.isSelected()) {
				answer="c.Instance varibles";
			}
			if(answer4.isSelected()) {
				answer="d. Local variables";
			}
			if(answer=="d. Local variables")
			{
