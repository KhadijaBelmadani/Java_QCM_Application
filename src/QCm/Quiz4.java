...
public class Quiz4 implements ActionListener {
	...
	JLabel Title = new JLabel("Question4");
	JLabel question1 = new JLabel( "4) Which of th following variable types is not permitted in a switch statment? ");
	JCheckBox answer1 = new JCheckBox("a. String");
	JCheckBox answer2 = new JCheckBox("b. double");
	JCheckBox answer3 = new JCheckBox("c. int");
	JCheckBox answer4 = new JCheckBox("d. char");
