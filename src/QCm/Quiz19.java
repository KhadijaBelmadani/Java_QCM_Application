...
public class Quiz19 implements ActionListener {
	static int count;
	JFrame frame = new JFrame();
	JLabel Title = new JLabel("Question19");
	JLabel question1 = new JLabel( "19) Which of the following is a valid JavaBean method prefix");
	JCheckBox answer1 = new JCheckBox("a. is");
	JCheckBox answer2 = new JCheckBox("b. gimme");
	JCheckBox answer3 = new JCheckBox("c.request");
	JCheckBox answer4 = new JCheckBox("d. put");
