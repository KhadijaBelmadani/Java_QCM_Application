...
public class Quiz1 implements ActionListener{
	...
	JLabel Title = new JLabel("Question1");
	JLabel question1 = new JLabel( "1) What is the proper filename extension for a java bytecode compiled file ? ");
	JCheckBox answer1 = new JCheckBox("a. java");
	JCheckBox answer2 = new JCheckBox("b. bytecode");
	JCheckBox answer3 = new JCheckBox("c. class");
	JCheckBox answer4 = new JCheckBox("d. dll");
