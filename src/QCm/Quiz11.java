...
public class Quiz11 implements ActionListener {
	static int count;
	JFrame frame = new JFrame();
	JLabel Title = new JLabel("Question11");
	JLabel question1 = new JLabel( "11) What is a possile output of the following code?"+"String[] strings=new String[2];"+"Sytem.out.println(strings);" );
	JCheckBox answer1 = new JCheckBox("a. [null,null]");
	JCheckBox answer2 = new JCheckBox("b. [,]");
	JCheckBox answer3 = new JCheckBox("c.[Ljava.lang.String;@74a14482");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==submitButton) {
			...
			if(answer3.isSelected()) {
				answer="c.[Ljava.lang.String;@74a14482";
			}
			if(answer4.isSelected()) {
				answer="d. None of the above";
			}
			if(answer=="c.[Ljava.lang.String;@74a14482")
			{
				JOptionPane.showMessageDialog(null, "The result is");
				JOptionPane.showMessageDialog(null, "Correct Answer");
				count+=1;
				Quiz12 q12=new Quiz12(count);
